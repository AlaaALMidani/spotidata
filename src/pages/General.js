...
export const General = () => {
  ...
  const [state, setState] = useState({logic:new State(data)});
  ...
  return (
    <Swiper className="">
      ...
      <SwiperSlide>
        <div className=" flex flex-col  items-center justify-start bg-gradient-to-r from-slate-950 to-slate-900 h-screen w-full">
          <nav className="bg-transparent border-b-gray-500 border-opacity-40 border-b-[1px] dark:bg-gray-900 dark:border-gray-700 p-4 flex mt-10 rounded-lg ">
            <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border rounded-lg bg-transparent md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 ">
              <li>
                <a
      ...
      <SwiperSlide>
        <div className=" flex flex-col  items-center justify-start bg-gradient-to-r from-slate-950 to-slate-800 h-screen w-full">
          <nav className="bg-transparent border-b-gray-500 border-opacity-40 border-b-[1px] dark:bg-gray-900 dark:border-gray-700 p-4 flex mt-10 rounded-lg ">
            <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border rounded-lg bg-transparent md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 ">
              <li>
                <a
